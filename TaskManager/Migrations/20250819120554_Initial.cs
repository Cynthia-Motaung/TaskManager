    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskDependencies", x => new { x.TaskItemId, x.DependsOnTaskId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 8, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "Redesign corporate website", "Website Redesign" },
                    { 2, new DateTime(2025, 8, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "Develop new mobile app", "Mobile App" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "charlie@example.com", "Charlie Lee" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "PlaceHolder", null, "High", 1, "Pending", "Design Landing Page" },
                    { 2, "PlaceHolder", null, "Medium", 2, "InProgress", "Setup Database" },
                    { 3, "PlaceHolder", null, "High", 2, "Pending", "Implement Authentication" }
                });
